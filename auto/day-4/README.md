# Night 4 auto-generation

Assets for a live evening episode: **Night 4 of 5 — Make it yours**.

## Spoken duration

**2,127 spoken words** at 140 wpm = **15:12**. That is the runtime. Do not pad silence. Do not stretch clips toward a 15:00 wall-clock if the words are shorter, and do not trim speech to fit 15:00 if the words are longer. Fifteen minutes is spoken teaching, not holds.

Beats: 13. Longest TTS paste: beat 6 (hyprland.lua family), 1098 characters (limit 4000).
...
4. **Concat.** `ffmpeg -f concat` into `day-4.mp4`.
...
`speak` is the Night 4 You say column, cleaned to spoken prose. Hotkeys are written “Super plus K” so a TTS engine does not eat the `+`.
